...
public class CellCoinRechargeResponseDTO {

    private Integer nsuNameProvider;

    private Integer authentication;

    private CellCoinRechargeReceiptDTO receipt;
    ...
    public CellCoinRechargeReceiptDTO getReceipt() {
        return receipt;
    }

    public void setReceipt(CellCoinRechargeReceiptDTO receipt) {
